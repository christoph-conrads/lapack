*> \brief \b CGETRP computes the conjugate transpose of a matrix.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download CGETRP + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/cgetrp.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/cgetrp.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/cgetrp.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE CGETRP( M, N, S, LDS, D, LDD, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> CGETRP computes the conjugate transpose of the complex M-by-N source
