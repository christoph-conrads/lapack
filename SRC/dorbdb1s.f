...
*  ===========
*
*       SUBROUTINE DORBDB1S( M, P, Q, X11, LDX11, X21, LDX21, THETA, PHI,
...
*
*     .. Parameters ..
      DOUBLE PRECISION   NEGONE, ONE, REALONE, ZERO
...
*
      DO I = 1, Q
*
         IF( SIGN( REALONE, X11(I,I) ) .EQ. REALONE ) THEN
            IF( WANTU1 ) THEN
               CALL DSCAL( P, NEGONE, U1(1,I), 1 )
            END IF
